...
import gt.com.tigo.accruedautomation.model.vhur.*;
...
public class Utils {
     ...
     */
    public static Specification<EmpleadosVhurEntity> getDefaultSpecification() {
        return new Specification<EmpleadosVhurEntity>() {
            @Override
            public Predicate toPredicate(Root<EmpleadosVhurEntity> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
